      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.headerBand} fixed>
          <View style={styles.logoArea}>
            <Image src="/logo.png" style={{ width: 30, height: 30, backgroundColor: "#f6f6f6", padding: "2px 1.5px", borderRadius: "8px" }} />
            <View>
        ...
        <View style={styles.footer} fixed>
          ...
          <Text style={styles.footerBrand}>chefmate.psbvision.engineer</Text>
        </View>
      </Page>
    </Document>
  );
